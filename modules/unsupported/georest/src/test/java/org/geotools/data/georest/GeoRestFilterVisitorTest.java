...
public class GeoRestFilterVisitorTest extends TestCase {
    ...
    public void testPropertyIsEqualTo() {
        ...
        PropertyIsEqualTo filter =
                FF.equals(FF.property(PROPERTY_NAME), FF.literal(PROPERTY_VALUE));
    ...
    public void testPropertyIsNotEqualTo() {
        ...
        PropertyIsNotEqualTo filter =
                FF.notEqual(FF.property(PROPERTY_NAME), FF.literal(PROPERTY_VALUE));
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        Assert.assertEquals(
                URL
    ...
    public void testPropertyIsGreaterThan() {
        ...
        PropertyIsGreaterThan filter =
                FF.greater(FF.property(PROPERTY_NAME), FF.literal(PROPERTY_VALUE));
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        Assert.assertEquals(
                URL
    ...
    public void testPropertyIsGreaterThanOrEqualTo() {
        ...
        PropertyIsGreaterThanOrEqualTo filter =
                FF.greaterOrEqual(FF.property(PROPERTY_NAME), FF.literal(PROPERTY_VALUE));
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        Assert.assertEquals(
                URL
    ...
    public void testPropertyIsLessThanOrEqualTo() {
        ...
        PropertyIsLessThanOrEqualTo filter =
                FF.lessOrEqual(FF.property(PROPERTY_NAME), FF.literal(PROPERTY_VALUE));
        visitor.visit(filter, null);
        visitor.finish(builder, false);
        Assert.assertEquals(
                URL
