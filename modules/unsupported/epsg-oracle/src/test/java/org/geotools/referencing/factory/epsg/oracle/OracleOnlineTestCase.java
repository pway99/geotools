 ...
 *
 * <p>To run this test you will need to supply a "fixture" in
 * "%USERHOME%/.geotools/epsg/oracle.properties" The contents of this file are as follows:
 *
 * <pre><code>
 * user=****
 * password=****
 ...
 * </code></pre>
 *
 * <p>This test requires ojdbc14.jar in order to run.
 *
 * <p><b>Instructions for Maven:</b> set the environmental variable "oracle.jdbc" to true (this will
 * enable the oracle.jdbc-true profile and disable the oracle.jdbc-false profile) ... basically
 * sticking a real ojdbc14.jar in your path so we have a real driver to work with.
 *
 * <p>
 *
