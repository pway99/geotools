...
public class sldComplexTypes {
    ...
    static class _Displacement extends sldComplexType {
        ...
        private static final ElementGrouping child =
                new SequenceGT(
                        ...
                        new ElementGrouping[] {
                            new sldElement(
                                    "DisplacementX", ParameterValueType.getInstance(), null, 1, 1),
                            new sldElement(
                                    "DisplacementY", ParameterValueType.getInstance(), null, 1, 1)
                        },
                        1,
                        1);
    ...
    static class _GraphicStroke extends sldComplexType {
        ...
        private static final ElementGrouping child =
                new SequenceGT(
                        null,
                        new ElementGrouping[] {new sldElement("Graphic", null, null, 1, 1)},
                        1,
                        1);
    ...
    static class _Extent extends sldComplexType {
        ...
        private static final Element[] elems = {
            ...
            new sldElement(
                    "Value", org.geotools.xml.xsi.XSISimpleTypes.String.getInstance(), null, 1, 1)
        };
                        ...
                        new ElementGrouping[] {
                            new SequenceGT(
                                    ...
                                    new ElementGrouping[] {
                                        new sldElement(
                                                "RedChannel",
                                                SelectedChannelType.getInstance(),
                                                null,
                                                1,
                                                1),
                                        new sldElement(
                                    ...
                                    1),
                            new sldElement(
                                    "GrayChannel", SelectedChannelType.getInstance(), null, 1, 1)
                        });
    ...
    static class _AnchorPoint extends sldComplexType {
        ...
        private static final ElementGrouping child =
                new SequenceGT(
                        ...
                        new ElementGrouping[] {
                            new sldElement(
                                    "AnchorPointX", ParameterValueType.getInstance(), null, 1, 1),
                            new sldElement(
                                    "AnchorPointY", ParameterValueType.getInstance(), null, 1, 1)
                        },
                        1,
                        1);
    ...
    static class _LabelPlacement extends sldComplexType {
        ...
        private static final ElementGrouping child =
                new ChoiceGT(
                        ...
                        new ElementGrouping[] {
                            new sldElement(
                                    "PointPlacement", _PointPlacement.getInstance(), null, 1, 1),
                            new sldElement(
    ...
    static class _ImageOutline extends sldComplexType {
        ...
        private static final ElementGrouping child =
                new ChoiceGT(
                        ...
                        new ElementGrouping[] {
                            new sldElement(
                                    "LineSymbolizer", _LineSymbolizer.getInstance(), null, 1, 1),
                            new sldElement(
                                    "PolygonSymbolizer",
                                    _PolygonSymbolizer.getInstance(),
                                    null,
                                    1,
                                    1)
                        });
