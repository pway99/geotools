 ...
 *
 * <p>This implementation asks you to implement:
 *
 * <ul>
...
public abstract class AbstractFeatureCollection implements SimpleFeatureCollection {
     ...
     *
     * <p>You are asked to perform the following check when finished with the iterator:
     *
     * <pre> if( e instanceof FeatureIterator ){
