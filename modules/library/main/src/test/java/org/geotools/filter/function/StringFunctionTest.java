...
public class StringFunctionTest {
    ...
    public void testParseLong() {
        assertEquals(
                Long.MAX_VALUE,
                ff.function("parseLong", ff.literal(Long.MAX_VALUE + "")).evaluate(null));
    ...
    public void testCapitalize() {
        assertEquals(
                "United Kingdom",
                ff.function("strCapitalize", ff.literal("UNITED KINGDOM")).evaluate(null));
        assertEquals(
                "United Kingdom",
                ff.function("strCapitalize", ff.literal("UnItEd kInGdOm")).evaluate(null));
    }
    ...
    public void testStrSubstring() {
        ...
        assertEquals(
                "",
                ff.function("strSubstring", ff.literal(""), ff.literal(0), ff.literal(0))
                        .evaluate(null));
    ...
    public void testConcatenate() {
        ...
        assertEquals(
                "a", ff.function("strConcat", ff.literal("a"), ff.literal(null)).evaluate(null));
        assertEquals(
                "b", ff.function("strConcat", ff.literal(null), ff.literal("b")).evaluate(null));
