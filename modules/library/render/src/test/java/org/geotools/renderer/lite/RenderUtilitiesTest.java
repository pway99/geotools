...
public class RenderUtilitiesTest {
    ...
    public void testWorld() throws Exception {
        ...
        Assert.assertEquals(52830886, scale, 1);
    }
    ...
    public void testWorldTwice() throws Exception {
        ...
        double scale = RendererUtilities.calculateScale(re, 1000, 500, 75);
        Assert.assertEquals(52830886 * 2, scale, 1);
    }
    ...
    public void testScaleProjected() throws Exception {
        ...
        Assert.assertEquals(100.0, scale, 0.1); // account for projection deformation
    }
    ...
    public void testCenterTile() throws Exception {
        ...
        Assert.assertEquals(expected, scale, expected * 0.05); // no projection deformation here!
    }
    ...
    public void testFindCentralPoint() throws Exception {
        ...
        Assert.assertNotNull(RendererUtilities.getPolygonCentroid(g));
    }
}
