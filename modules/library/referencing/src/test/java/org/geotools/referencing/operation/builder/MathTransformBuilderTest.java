...
public final class MathTransformBuilderTest {
    ...
    /**
     * Implements the method for testing the calculation of least square method. The main
     * requirement of least square method is that A<sup>T<sup>PAx + A<sup>T<sup>PX = 0.
     *
     * @author jezekjas
     */
