 ...
 * definitions of authority codes. An <cite>authority code</cite> is a compact string defined by an
 * authority to reference a particular spatial reference object. For example the <A
 ...
 * ID. For example, the EPSG code for a WGS84 Lat/Lon coordinate system is {@code "4326"}.
 *
 * <p>This class defines a default implementation for most methods defined in the {@link
 * DatumAuthorityFactory}, {@link CSAuthorityFactory} and {@link CRSAuthorityFactory} interfaces.
 * However, those interfaces do not appear in the {@code implements} clause of this class
 * declaration. This is up to subclasses to decide which interfaces they declare to implement.
 *
 * <p>The default implementation for all {@code createFoo} methods ultimately invokes {@link
 * #createObject}, which may be the only method that a subclass need to override. However, other
...
public abstract class AbstractAuthorityFactory extends ReferencingFactory
    ...
    /**
     * Returns {@code true} if this factory is available. This method may returns {@code false} for
     ...
     *
     * <p>This method should perform a cheap test. It is for {@link FallbackAuthorityFactory}
    ...
    /**
     * Returns a description of the underlying backing store, or {@code null} if unknown. This is
     ...
     * {@link Datum}, {@link CoordinateSystem}, {@link CoordinateReferenceSystem} or {@link
     * CoordinateOperation}. The default implementation always throw an exception. Subclasses should
    ...
    /**
     * Returns an arbitrary {@linkplain Datum datum} from a code. The default implementation invokes
     * <code>{@linkplain #createObject createObject}(code)</code>.
     *
     * @param code Value allocated by authority.
    ...
    /**
     * Creates a {@linkplain EngineeringDatum engineering datum} from a code. The default
     * implementation invokes <code>{@linkplain #createDatum createDatum}(code)</code>.
     *
     * @param code Value allocated by authority.
     * @return The datum for the given code.
     * @throws NoSuchAuthorityCodeException if the specified {@code code} was not found.
    ...
    /**
     * Creates a {@linkplain ImageDatum image datum} from a code. The default implementation invokes
     * <code>{@linkplain #createDatum createDatum}(code)</code>.
     *
     * @param code Value allocated by authority.
     * @return The datum for the given code.
     * @throws NoSuchAuthorityCodeException if the specified {@code code} was not found.
    ...
    /**
     * Creates a {@linkplain VerticalDatum vertical datum} from a code. The default implementation
     * invokes <code>{@linkplain #createDatum createDatum}(code)</code>.
     *
     * @param code Value allocated by authority.
     * @return The datum for the given code.
     * @throws NoSuchAuthorityCodeException if the specified {@code code} was not found.
    ...
    /**
     * Creates a {@linkplain TemporalDatum temporal datum} from a code. The default implementation
     * invokes <code>{@linkplain #createDatum createDatum}(code)</code>.
     *
     * @param code Value allocated by authority.
     * @return The datum for the given code.
    ...
    /**
     * Returns a {@linkplain GeodeticDatum geodetic datum} from a code. The default implementation
     * invokes <code>{@linkplain #createDatum createDatum}(code)</code>.
     *
     * @param code Value allocated by authority.
     * @return The datum for the given code.
    ...
    /**
     * Returns an {@linkplain Ellipsoid ellipsoid} from a code. The default implementation invokes
     * <code>{@linkplain #createObject createObject}(code)</code>.
     *
     * @param code Value allocated by authority.
     ...
     * invokes <code>{@linkplain #createObject createObject}(code)</code>.
     *
     * @param code Value allocated by authority.
    ...
    /**
     * Returns a {@linkplain Extent extent} (usually an area of validity) from a code. The default
     * implementation invokes <code>{@linkplain #createObject createObject}(code)</code>.
     *
     * @param code Value allocated by authority.
    ...
    /**
     * Returns an arbitrary {@linkplain CoordinateSystem coordinate system} from a code. The default
     * implementation invokes <code>{@linkplain #createObject createObject}(code)</code>.
     *
     * @param code Value allocated by authority.
    ...
    /**
     * Creates a cylindrical coordinate system from a code. The default implementation invokes
    ...
    /**
     * Creates an ellipsoidal coordinate system from a code. The default implementation invokes
     * <code>{@linkplain #createCoordinateSystem createCoordinateSystem}(code)</code>.
     *
     * @param code Value allocated by authority.
     * @return The coordinate system for the given code.
    ...
    /**
     * Returns a {@linkplain CoordinateSystemAxis coordinate system axis} from a code. The default
     * implementation invokes <code>{@linkplain #createObject createObject}(code)</code>.
     *
     * @param code Value allocated by authority.
     ...
     * HREF="http://www.epsg.org">EPSG</A>, not to compute operations on-the-fly.
     *
     * <p><strong>Rational:</strong> Coordinate operation factory {@linkplain
     * org.geotools.referencing.operation.AuthorityBackedFactory backed by an authority} will invoke
     * this method. If this method invoked the coordinate operation factory in turn, the application
     * could be trapped in infinite recursive calls.
     *
    ...
    /**
     * Releases resources immediately instead of waiting for the garbage collector. Once a factory
     * has been disposed, further {@code create(...)} invocations may throw a {@link
     * FactoryException}. Disposing a previously-disposed factory, however, has no effect.
     *
    ...
    /**
     * Creates an exception for an unknow authority code. This convenience method is provided for
     ...
     */
    private NoSuchAuthorityCodeException noSuchAuthorityCode(
