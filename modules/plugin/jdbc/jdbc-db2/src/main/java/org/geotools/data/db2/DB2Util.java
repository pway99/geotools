...
public class DB2Util {
    ...
    public static void executeRegister(
            String schemaName, String tableName, String columnName, String srsName, Connection con)
            throws SQLException {
    ...
    public static void executeRegisterAndCalculateExtent(
            String schemaName, String tableName, String columnName, String srsName, Connection con)
            throws SQLException {
    ...
    public static void prepareGeometryValue(
            Class<? extends Geometry> gClass, int srid, Class binding, StringBuffer sql) {
        String pattern = null;

        if (gClass != null) pattern = PARAMETER_MARKES.get(gClass);
        if (pattern == null) pattern = PARAMETER_MARKES.get(binding);
