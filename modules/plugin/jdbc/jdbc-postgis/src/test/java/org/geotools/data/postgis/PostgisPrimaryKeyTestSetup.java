...
public class PostgisPrimaryKeyTestSetup extends JDBCPrimaryKeyTestSetup {
    ...
    @Override
    protected void dropNullPrimaryKeyTable() {
        runSafe("DROP TABLE \"nokey\"");
    }

    @Override
    protected void dropUniqueIndexTable() {
        runSafe("DROP TABLE \"uniq\"");
    }

    @Override
    protected void dropNonFirstPrimaryKeyTable() {
        runSafe("DELETE FROM GEOMETRY_COLUMNS WHERE F_TABLE_NAME = 'nonfirst'");
