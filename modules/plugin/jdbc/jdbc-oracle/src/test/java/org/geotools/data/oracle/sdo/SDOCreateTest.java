 ...
 * work correctly to read raw Oracle SDO_GEOMETRY structures into {@link Geometry} objects. These
 * tests do not require a connection to Oracle.
 *
 * @author mbdavis
 */
    ...
    public void testXYMZ_MultiLineString() {
        SDO_GEOMETRY oraGeom =
                MDSYS.SDO_GEOMETRY(
                        ...
                        8307,
                        NULL,
                        MDSYS.SDO_ELEM_INFO_ARRAY(1, 2, 1, 9, 2, 1),
                        MDSYS.SDO_ORDINATE_ARRAY(
                                0, 0, 2, 3, 50, 50, 100, 200, 10, 10, 12, 13, 150, 150, 110, 210));
        checkValue(oraGeom, "MULTILINESTRING ((0 0, 50 50), (10 10, 150 150))");
    }
    ...
    public void testXYZ_Polygon() {
        SDO_GEOMETRY oraGeom =
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ELEM_INFO_ARRAY(1, 1003, 1),
                        MDSYS.SDO_ORDINATE_ARRAY(
                                0, 0, 99, 50, 0, 99, 50, 50, 99, 0, 50, 99, 0, 0, 99));
        checkValue(oraGeom, "POLYGON ((0 0, 50 0, 50 50, 0 50, 0 0))");
    }
    ...
    public void testXYZ_PolygonWithHole() {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                2, 4, 99, 4, 3, 99, 10, 3, 99, 13, 5, 99, 13, 9, 99, 11, 13, 99, 5,
    ...
    public void testXY_MultiPolygon() {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                2, 3, 7, 3, 7, 9, 2, 9, 2, 3, 9, 5, 13, 5, 11, 5, 9, 5)),
    ...
    public void testXYZ_MultiPolygon() {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        MDSYS.SDO_ORDINATE_ARRAY(
                                2, 3, 99, 7, 3, 99, 7, 9, 99, 2, 9, 99, 2, 3, 99, 9, 5, 99, 13, 5,
                                99, 11, 5, 99, 9, 5, 99)),
                "MULTIPOLYGON (((2 3, 7 3, 7 9, 2 9, 2 3)), ((9 5, 13 5, 11 5, 9 5)))");
    }
    ...
    public void testXY_GeometryCollection_Doc() {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        NULL,
                        MDSYS.SDO_ELEM_INFO_ARRAY(
                                1, 1, 1, 3, 2, 1, 7, 1003, 1, 17, 1003, 1, 25, 2003, 1),
                        MDSYS.SDO_ORDINATE_ARRAY(
                                1, 1, 1, 2, 2, 1, 2, 2, 3, 2, 3, 3, 2, 3, 2, 2, 5, 1, 9, 5, 5, 5, 5,
                                1, 5, 3, 6, 4, 6, 3, 5, 3)),
    ...
    public void testXYM_GeometryCollection_Doc() {
        checkValue(
                MDSYS.SDO_GEOMETRY(
                        ...
                        NULL,
                        MDSYS.SDO_ELEM_INFO_ARRAY(
                                1, 1, 1, 4, 2, 1, 10, 1003, 1, 25, 1003, 1, 37, 2003, 1),
                        MDSYS.SDO_ORDINATE_ARRAY(
                                1, 1, 99, 1, 2, 99, 2, 1, 99, 2, 2, 99, 3, 2, 99, 3, 3, 99, 2, 3,
                                99, 2, 2, 99, 5, 1, 99, 9, 5, 99, 5, 5, 99, 5, 1, 99, 5, 3, 99, 6,
                                4, 99, 6, 3, 99, 5, 3, 99)),
                "GEOMETRYCOLLECTION (POINT (1 1), LINESTRING (1 2, 2 1), POLYGON ((2 2, 3 2, 3 3, 2 3, 2 2)), POLYGON ((5 1, 9 5, 5 5, 5 1), (5 3, 6 4, 6 3, 5 3)))");
    }
