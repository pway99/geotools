...
/**
 * This dialect uses the Oracle 10 specific sdoapi.jar API, which is touted to be faster than then
 ...
 * only for historical purposes. Un comment here and in OracleDialect if you want to try it out.
 *
 * @author Andrea Aime
 */
