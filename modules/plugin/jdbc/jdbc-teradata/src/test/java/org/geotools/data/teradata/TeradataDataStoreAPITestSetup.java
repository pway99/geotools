...
public class TeradataDataStoreAPITestSetup extends JDBCDataStoreAPITestSetup {
    ...
    protected void createRoadTable() throws Exception {
        ...
        run(
                "CREATE TABLE \"road\"(\"fid\" PRIMARY KEY not null generated always as identity (start with 0) integer, \"id\" int, "
        ...
        //                + "  REFERENCING OLD TABLE AS ot" + "  FOR EACH STATEMENT" + "  BEGIN
        // ATOMIC"
        //                + "  (" + "    DELETE FROM \"road_geom_idx\" WHERE ID IN (SELECT ID from
        // ot);"
        //                + "  )" + "END");
